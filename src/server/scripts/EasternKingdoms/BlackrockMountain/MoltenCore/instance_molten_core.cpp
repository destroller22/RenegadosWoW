...
class instance_molten_core : public InstanceMapScript
{
    public:
        ...
        struct instance_molten_core_InstanceMapScript : public InstanceScript
        {
            ...
            void OnCreatureCreate(Creature* creature) override
            {
                switch (creature->GetEntry())
                {
                    ...
                    case NPC_MAJORDOMO_EXECUTUS:
                        ...
                        break;
                    case NPC_MAJORDOM_EXECUTUS_RAGNAROS:
                        _majordomoExecutusRagGUID = creature->GetGUID();
                        break;
                    default:
                        break;
                }
            ...
            ObjectGuid GetGuidData(uint32 type) const override
            {
                switch (type)
                {
                    ...
                    case BOSS_MAJORDOMO_EXECUTUS_RAG:
                        return _majordomoExecutusRagGUID;
                }
            ...
            bool SetBossState(uint32 bossId, EncounterState state) override
            {
				...
				if (bossId == BOSS_MAJORDOMO_EXECUTUS && state == DONE)
				{
					...
					instance->SummonCreature(NPC_MAJORDOM_EXECUTUS_RAGNAROS, RagnarosTelePos);
        ...
        private:
            ...
            ObjectGuid _majordomoExecutusRagGUID;
