    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature) override
        {
            ...
            if (player->GetQuestStatus(QUEST_HUMANOID_CANNONBALL) == QUEST_STATUS_INCOMPLETE)
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Deseo convertirme en un pistolero!", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 /*action*/) override
        {
            ...
            {
                creature->Whisper("Debes tener un Token de Luna Negra para usar el cañón!", LANG_UNIVERSAL, player);
    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature) override
        {
            ...
            if (player->GetQuestStatus(QUEST_HUMANOID_CANNONBALL) != QUEST_STATUS_NONE)
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Teletransportame al cañón !", GOSSIP_SENDER_MAIN, 0, "¿Te gustaría pagar 30 piezas de plata?", 3000, false);
