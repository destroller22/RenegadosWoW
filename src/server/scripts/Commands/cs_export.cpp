/*
* Copyright (C) 2016-2018 FSocietyWoW-Legion <http://foro.renegadoswow.com//>
*
    ...
    bool exportCreature(uint32 aEntry)
    {
        ...
        if ( _Result )
        {
            ...
            do
            {
                ...
                uint64 spawnMAsk = data->spawnMask;
                //uint16 map       = data->mapid;
                ...
                spawnMAsk = _Fields [_Index++].GetUInt64();
